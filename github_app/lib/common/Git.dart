...
//    return User.fromJson(r.data);
  ...
  String userStr =  await _loadUserJson();
  final jsonMap = json.decode(userStr);
...
//    return r.data.map((e) => Repo.fromJson(e)).toList();
    String repoStr =  await rootBundle.loadString('jsons/repo.json');
    final jsonMap = json.decode(repoStr);
    Repo repo = Repo.fromJson(jsonMap);
    List <Repo> list = [];
    list.add(repo);
    list.add(repo);
    list.add(repo);
